...
public class QueryFilter implements Serializable {
    ...
    public static QueryFilter in(String property, Object... value) {
        ...
        return new QueryFilter(property, list, OP_IN);
    }
    ...
    public static QueryFilter notIn(String property, Object... value) {
        ...
        return new QueryFilter(property, list, OP_NOT_IN);
    }
     ...
     */
    private static QueryFilter ilike(String property, String value) {
     ...
     * filter to that list.
     */
    private  void add(QueryFilter filter) {
     ...
     */
    private void remove(QueryFilter filter) {
        if (value == null || !(value instanceof List)) {
            return;
        }
...
/*   public  Value   generateSQLAndParamMap(){
  ...
  /*
    ...
    public static class Joiner{
        ...
        public static QueryFilter and(Collection<QueryFilter> filters) {
            QueryFilter filter = new QueryFilter("AND", null, OP_AND);
            for (QueryFilter f : filters) {
                filter.add(f);
            }
